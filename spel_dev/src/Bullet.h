...
public:
     ...
     *
     * @param[in] damage The damage that the bullet should deal upon impact with a valid target.
     * @param[in] direction The initial direction that the bullet is to be fired in.
     ...
     * @param[in] world A reference to the World object that the Bullet object exists in.
     * @param[in] current_obj A shared pointer to the instance of the current bullet as stored in World.
     */
