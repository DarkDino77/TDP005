...
public:
     ...
     *
     * @param[in] position The initial position of the Destructible object.
     * @param[in] sprite The texture that is used to render the Destructible object.
     * @param[in] health The amount of health points that the destructible object has.
     */
     ...
     * @param[in] world A reference to the World object that the Destructible object exists in.
     * @param[in] current_obj A shared pointer to the instance of the current Destructible, as stored in World.
     */
     ...
     *
     * @param[in] destructible_target A shared pointer to the instance of the current Destructible, as stored in World.
     * @param[in] world A reference to the World object that the Destructible object exists in.
     */
